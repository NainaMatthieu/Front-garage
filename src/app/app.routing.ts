    ...
    // Admin routes
    {
        ...
        children   : [
            ...
            {path: 'apps', children: [
                ...
                {path: 'reception', loadChildren: () => import('app/modules/admin/apps/reception/reception.module').then(m => m.ReceptionModule)},
            ...
            {path: 'pages', children: [
                ...
                {path: 'statistiques', loadChildren: () => import('app/modules/admin/pages/statistiques/statistiques.module').then(m => m.StatistiquesModule)},
            ]},
